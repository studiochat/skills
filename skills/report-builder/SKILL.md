...
Instructions should define **what** to analyze and **what output** to produce — never **how** to get the data.

### Instruction Principles

1. **Describe the analysis, not the implementation** — "Show deflection rate by playbook" is correct. "Call GET /projects/.../analytics" is wrong — the data-expert skill already knows how.
